...
public class HelperLogin extends HelperBase{
    ...
    private By OPEN_LOGIN_PAGE_BTN = By.xpath("//a[contains(text(), 'Log in')]");
    private By INPUT_EMAIL = By.xpath("//input[@id='user']");
    private By BTN_LOGIN = By.xpath("//input[@id='login']");
    private By INPUT_PASSWORD = By.xpath("//input[@name='password']");
    private By CONFIRM_PASSWORD_BTN = By.xpath("//button[@id='login-submit']");
    private By TEXT_WORKSPACE_AFTER_LOGIN = By.xpath("//span[@data-testid='home-team-tab-name']");
    private By TEXT_INCORRECT_PASSWORD = By.xpath("//div[@data-testid='form-error--content']/span/span");
